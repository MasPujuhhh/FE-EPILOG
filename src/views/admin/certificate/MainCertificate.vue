<template>
          ...
          >
            ...
            >
              ...
              <button
                ...
                @click="$router.push('/admin/certificate/add')"
              >
                    ...
                    >
                      ...
                      <td>
                        ...
                        >
                          ...
                          <a :href="`http://localhost:9001/assets/pdf/${u.url}`">
                            <button
                            type="button"
                            class="btn btn-info"
                            style="
  ...
  <script setup>
    ...
    const deleteCertificate = async () => {
      try {
        // console.log(nilai_id)
        await axios.delete(`${endpoint}/certificate/deleteCertificate/${nilai_id}`, {
          headers: {
            Authorization: `Bearer ${valid}`,
            "Content-Type": "application/json",
          },
        ...
        // const data = res.data;
        toast.success("Berhasil Delete Certificate", {
          autoClose: 2000,
        });
        setTimeout(() => {
          location.reload();
