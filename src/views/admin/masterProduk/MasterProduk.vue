      ...
      >
        ...
        >
          <div
            ...
            class="table-header"
          >
            <h4 style="font-weight: bold">Data Produk</h4>
            <button
              type="button"
              class="btn btn-success"
              style="font-weight: bold"
              @click="$router.push('/master/tambah/produk')"
            >
...
<script setup>
  ...
  const deleteProduk = async () => {
    try {
      ...
      // console.log(Bearer);
      let res = await axios.delete(`${endpoint}/produk/${id_produk.value}`, {
        headers: {
  ...
  const pindahDetail = async (id) => {
    try {
      // console.log(id);
      await simpanIdProduk(id);
      router.push({ path: "/master/detail/produk" });
    } catch (error) {
      console.log(error);
    }
  };
  ...
  const pindahEdit = async (id) => {
    try {
      // console.log(id);
      await simpanIdProduk(id);
      router.push({ path: "/master/edit/produk" });
    } catch (error) {
      console.log(error);
    }
  };
